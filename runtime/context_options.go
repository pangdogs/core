...
func (*_ContextOption) StartedCallback(v func(runtimeCtx Context)) ContextOptionSetter {
	return func(o *ContextOptions) {
		o.StartedCallback = v
	}
}
...
func (*_ContextOption) StoppingCallback(v func(runtimeCtx Context)) ContextOptionSetter {
	return func(o *ContextOptions) {
...
func (*_ContextOption) FrameBeginCallback(v func(runtimeCtx Context)) ContextOptionSetter {
	return func(o *ContextOptions) {
...
func (*_ContextOption) FrameEndCallback(v func(runtimeCtx Context)) ContextOptionSetter {
	return func(o *ContextOptions) {
...
func (*_ContextOption) FaceCache(v *container.Cache[util.FaceAny]) ContextOptionSetter {
	return func(o *ContextOptions) {
		o.FaceCache = v
	}
}
...
func (*_ContextOption) HookCache(v *container.Cache[localevent.Hook]) ContextOptionSetter {
	return func(o *ContextOptions) {
		o.HookCache = v
	}
}
