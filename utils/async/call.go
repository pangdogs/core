...
type Caller interface {
	...
	//	- 代码片段中的线程安全问题，如临界区访问、线程死锁等。
	//  - 调用过程中的panic信息，均会转换为error返回。
	CallDelegate(fun generic.DelegateFuncVar0[any, Ret], args ...any) AsyncRet
	...
	//	- 代码片段中的线程安全问题，如临界区访问、线程死锁等。
	//  - 调用过程中的panic信息，均会转换为error返回。
	CallVoidDelegate(fun generic.DelegateActionVar0[any], args ...any) AsyncRet
}
...
type Callee interface {
	...
	PushCallDelegate(fun generic.DelegateFuncVar0[any, Ret], args ...any) AsyncRet
	...
	PushCallVoidDelegate(fun generic.DelegateActionVar0[any], args ...any) AsyncRet
}
